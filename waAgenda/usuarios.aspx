...
<asp:SqlDataSource ID="SqlDataSourceUsuarios" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
    ...
    UpdateCommand="UPDATE [usuario] SET [nome] = @nome, [senha] = @senha WHERE [email] = @email" OnInserted="SqlDataSourceUsuarios_Inserted" OnInserting="SqlDataSourceUsuarios_Inserting" OnUpdated="SqlDataSourceUsuarios_Updated">
    <DeleteParameters>
